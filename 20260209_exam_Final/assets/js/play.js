/* <h1 id="title" 自定義數據屬性:data-固定前綴 txt自定義的名稱 ="lucky">運勢</h1>
data-...專屬js */
// getAttribute 取得屬性
...
// for...in 陣列或集合裡面的物件 (Object)	屬性名稱 (Key) 
// data 是物件，所以拿到 "今日運勢" 等字串  拿到的是："今日運勢"、"本週運勢" 這些「名字」
// for...of	陣列/集合 (Array)	內容物 (Value) 
// items 是標籤集合，拿到的是：<li> 標籤實體本身